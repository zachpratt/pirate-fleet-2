...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've hit a sea monster! Look out! You lose a turn..."
        static let ComputerHitMonster = "The computer has hit a sea monster! Take another turn!..."
